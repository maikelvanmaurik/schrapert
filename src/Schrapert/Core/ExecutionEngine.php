...
class ExecutionEngine
{
    ...
    public function __construct(LoggerInterface $logger, EventDispatcherInterface $events, ScraperInterface $scraper, DuplicateRequestFilterInterface $dupeFilter = null, RequestProcessorFactoryInterface $requestProcessorFactory, SchedulerInterface $scheduler, IntervalCallbackFactory $intervalCallbackFactory, DelayedCallbackFactory $delayedCallbackFactory)
    {
        $this->logger = $logger;
