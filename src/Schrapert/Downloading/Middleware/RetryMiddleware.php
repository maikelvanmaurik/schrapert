...
use Schrapert\Crawling\Exceptions\DropRequestException;
use Schrapert\Http\RequestInterface;
use Schrapert\Http\ResponseInterface;
use Schrapert\Log\LoggerInterface;

class RetryMiddleware implements DownloaderMiddlewareInterface, ProcessResponseMiddlewareInterface
{
    private $maxRetries;
