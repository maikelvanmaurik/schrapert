...
use Schrapert\Http\Downloader\Middleware\Event\ConcurrentRequestLimitTotalExceededEvent;
use Schrapert\Http\RequestInterface;
use Schrapert\Http\ResponseInterface;
use Schrapert\Log\LoggerInterface;
use Schrapert\Util\DelayedCallbackFactory;

class ConcurrentRequestLimitMiddleware implements DownloadMiddlewareInterface, ProcessRequestMiddlewareInterface, ProcessResponseMiddlewareInterface
{
    ...
    public function __construct(EventDispatcherInterface $events, LoggerInterface $logger, DelayedCallbackFactory $delayedCallbackFactory, Resolver $dnsResolver)
    {
        $this->events = $events;
        $this->logger = $logger;
